...
export type ModelType<T extends ModelTypeParamShape = ModelTypeParamShape, UsedMethod extends UsableModelTypeKey = never> = Omit<{
    ...
    authorization<AuthRuleType extends Authorization<any, any, any>>(callback: ModelTypeAuthorizationCallback<AuthRuleType>): ModelType<SetTypeSubArg<T, 'authorization', AuthRuleType[]>, UsedMethod | 'authorization'>;
}, UsedMethod>;
```
