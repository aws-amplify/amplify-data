...
export type RefType<T extends RefTypeParamShape, K extends keyof RefType<T> = never, Auth = undefined> = Omit<{
    ...
    authorization<AuthRuleType extends Authorization<any, any, any>>(callback: ReferenceAuthorizationCallback<AuthRuleType>): RefType<T, K | 'authorization', AuthRuleType>;
