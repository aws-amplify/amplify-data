...
```
**References:** [CustomOperationParamShape](./data-schema.customoperationparamshape.md)<!-- -->, [CustomOperation](./data-schema.customoperation.md)<!-- -->, [CustomOperationBrand](./data-schema.customoperationbrand.md)<!-- -->, [CustomArguments](./data-schema.customarguments.md)<!-- -->, [SetTypeSubArg](./data-schema.settypesubarg.md)<!-- -->, [CustomReturnType](./data-schema.customreturntype.md)<!-- -->, [Authorization](./data-schema.authorization.md)<!-- -->, [AllowModifierForCustomOperation](./data-schema.allowmodifierforcustomoperation.md)<!-- -->, [HandlerInputType](./data-schema.handlerinputtype.md)<!-- -->, [SubscriptionSource](./data-schema.subscriptionsource.md)<!-- -->, [Brand](./data-schema.brand.md)
