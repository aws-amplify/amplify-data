...
- 2591fb3: Fix the client-side `requires arguments` error thrown for nullable list arguments on custom operations ([#767](https://github.com/aws-amplify/amplify-data/issues/767)).
...
- d094457: `ClientSchema` now accepts a second generic for compile-time configuration:
