...
type T = Schema['CPKReciprocalHasManyChild'];
...
//     type TheSchema = ResolveSchema<typeof schema>;
//     type Identifiers = ModelIdentifier<SchemaTypes<typeof schema>>;

//     type Actual = Denormalized<TheSchema, Identifiers>;
...
//       }),
//     });
//     type T = ClientSchema<typeof schema>['MultiChild'];
